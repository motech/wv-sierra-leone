...
public class SMSContent {
    ...
    public static final String POSTNATAL_CONSULTATION_REMINDER = "You / (woman's name) have been referred for post-partum consultation care at your health centre. Please go directly to the facility as soon as possible";
