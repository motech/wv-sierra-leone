...
public final class Commcare {
    ...
    public static final String ATTENDED_PNC = "attended_pnc";
    ...
    public static final String CASE_ATTENDED_PNC = "case_attended_pnc";
    public static final String CASE_BCG = "case_bcg";
    ...
    public static final String OPV_0 = "opv0";
    ...
    public static final String VISIT_QUESTIONS = "visit_questions";
    public static final String VISIT_SUCCESS = "visit_success";
